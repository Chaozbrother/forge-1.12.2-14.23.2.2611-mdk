package de.Chaoz.CIndustry.gen;
...
public class OreGen implements IWorldGenerator {
    ...
    public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator iChunkGenerator, IChunkProvider iChunkProvider) {
        ...
        runGenerator(ModBlocks.URANIUM_BLOCK.getDefaultState(), 4, 10, 20, 40, BlockMatcher.forBlock(Blocks.STONE), world, random, chunkX, chunkZ);
    }
